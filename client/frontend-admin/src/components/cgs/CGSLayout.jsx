...
// } from '../../../../shared/ui/dropdown-menu';
// import { cn } from '../../lib/utils';
// import { authService } from '../../../../shared/services/api'; // make sure authService is properly imported
...
//     try {
//       await authService.logout(); // backend clears session/cookie
//     } catch (err) {
//       console.error('Logout failed', err);
//     } finally {
//       setUser(null);
//       if (onLogout) onLogout(); // clear app state
  ...
  useEffect(() => {
    const fetchUser = async () => {
      try {
        ...
        if (data?.user) {
          setUser(data.user);
          // Example: fetch notifications count if your API supports it
          // const notifData = await api.get('/notifications/count');
          // setNotifications(notifData.data.count);
        } else {
          handleLogout();
        }
      } catch (err) {

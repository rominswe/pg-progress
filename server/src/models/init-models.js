...
export default function initModels(sequelize) {
  ...
  // Staff Info & Employee Info
  pgstaffinfo.belongsTo(empinfo, { as: "emp", foreignKey: "emp_id" });
  empinfo.hasMany(pgstaffinfo, { as: "pgstaffinfos", foreignKey: "emp_id" });
  // Defense Evaluations & Staff (Evaluator)
  defense_evaluations.belongsTo(pgstaffinfo, { as: "evaluator", foreignKey: "evaluator_id" });
  pgstaffinfo.hasMany(defense_evaluations, { as: "defense_evaluations", foreignKey: "evaluator_id" });
  // Document Reviews & Staff
  documents_reviews.belongsTo(pgstaffinfo, { as: "reviewed_by_pgstaffinfo", foreignKey: "reviewed_by" });
  pgstaffinfo.hasMany(documents_reviews, { as: "documents_reviews", foreignKey: "reviewed_by" });
  // Staff Expertise
  ...
  // Defense Evaluations & Students
  defense_evaluations.belongsTo(pgstudinfo, { as: "pg_student", foreignKey: "pg_student_id" });
  pgstudinfo.hasMany(defense_evaluations, { as: "defense_evaluations", foreignKey: "pg_student_id" });
  // Document Uploads & Students
  documents_uploads.belongsTo(pgstudinfo, { as: "pg_student", foreignKey: "pg_student_id" });
  pgstudinfo.hasMany(documents_uploads, { as: "documents_uploads", foreignKey: "pg_student_id" });
  // Progress Updates
  progress_updates.belongsTo(pgstudinfo, { as: "pg_student", foreignKey: "pg_student_id" });
  pgstudinfo.hasMany(progress_updates, { as: "progress_updates", foreignKey: "pg_student_id" });
  ...
  pgstaffinfo.hasMany(role_assignment, { as: "requester_role_assignments", foreignKey: "requested_by" });
  // Service Requests
  service_requests.belongsTo(pgstudinfo, { as: "pg_student", foreignKey: "pg_student_id" });
  pgstudinfo.hasMany(service_requests, { as: "service_requests", foreignKey: "pg_student_id" });
  // Program Info & Students
  ...
  // Evaluator Roles
  defense_evaluations.belongsTo(roles, { as: "evaluator_role_role", foreignKey: "evaluator_role" });
  roles.hasMany(defense_evaluations, { as: "defense_evaluations", foreignKey: "evaluator_role" });
  // Staff Roles Definitions
  ...
  studinfo.hasMany(pgstudinfo, { as: "pgstudinfo", foreignKey: "stu_id" });
